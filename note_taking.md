...
I started using Obsidian to organize my cybersecurity notes, especially topics like ports, protocols, and vulnerabilities. Instead of keeping everything in separate documents, I wanted a way to connect related concepts together.
...
{SCREENSHOT REMINDER: SSH note with multiple links}
...
This helped me understand how Obsidian can organize complex topics, but also showed that too many connections can make things harder to manage.
